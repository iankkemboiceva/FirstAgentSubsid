 ...
 */
public class ResideMenuClass extends FrameLayout{
    ...
    private LinearLayout scrollViewRightMenu;
    ...
    public ResideMenuClass(Context context) {
        super(context);
        initViews(context);
    }
    ...
    private void initViews(Context context){
        ...
        scrollViewRightMenu = (LinearLayout) findViewById(R.id.sv_right_menu);
    ...
    public void addLeftMenuItem(ResideMenuItem menuItem){
            this.leftMenuItems.add(menuItem);
            linear_left.addView(menuItem);
    }

    public void addBottomMenuItem(ResideMenuItem menuItem){
        this.leftMenuItems.add(menuItem);
        linear_bottom.addView(menuItem);
    }
    ...
    private void rebuildMenu(){
        ...
        linear_bottom.removeAllViews();

        int last = 0;
        for(int i = 0; i < leftMenuItems.size() ; i ++)
            layoutLeftMenu.addView(leftMenuItems.get(i), i);
        for(int i = 0; i < rightMenuItems.size()-1 ; i ++){
        	last = i;
        	layoutRightMenu.addView(rightMenuItems.get(i), i);
        }
        linear_left.addView(leftMenuItems.get(last+1), last+1);
        linear_bottom.addView(leftMenuItems.get(last+1), last+1);
    }
