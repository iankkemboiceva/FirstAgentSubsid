...
public class CableTVActivity extends BaseActivity implements View.OnClickListener {
                            ...
                            if (Utility.isNotNull(narra)) {
                                if (Utility.isNotNull(ednamee)) {
                                    if (Utility.isNotNull(ednumbb)) {
                                        ...
                                        Intent intent  = new Intent(CableTVActivity.this,ConfirmCableActivity.class);
...
/*
                            ...
                            Toast.makeText(
                                    getApplicationContext(),
                                    "Please enter an amount value more than 100"+session.getString("CURRENCY"),
                                    Toast.LENGTH_LONG).show();
                        }
                    }
                    else {
        ...
        if (view.getId() == R.id.tv2) {
          /*  Fragment  fragment = new BillMenu();
            ...
            finish();
            Intent intent  = new Intent(CableTVActivity.this,BillMenuActivity.class);
