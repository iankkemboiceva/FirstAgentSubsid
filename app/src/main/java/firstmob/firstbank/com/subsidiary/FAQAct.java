...
public class FAQAct extends AppCompatActivity {
    ...
    private void prepareListData() {
        ...
        listDataHeader.add("Do I need a First Bank account to enjoy this service?");
        listDataHeader.add("Who do I contact for support?");
        // Adding child data
        List<String> top250 = new ArrayList<String>();
        top250.add(" a) Download and install from the stores b) Receive Activation PIN from First Bank of Nigeria through your SMS or email address(Please do not share this PIN with anyone else). c) Proceed to open app and will be taken to activation page d) Proceed to fill the activation details and change the activation PIN ");
    ...
    public void SetFAQ(){
        ...
        planetsList.add(new OTBList("Do i need a First Bank account to enjoy this service?","058"));
