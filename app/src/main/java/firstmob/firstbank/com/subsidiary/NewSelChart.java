...
public class NewSelChart extends Fragment implements View.OnClickListener,OnChartValueSelectedListener,DateRangePickerFragment.OnDateRangeSelectedListener, OnChartGestureListener {
    ...
    private static final String ARG_PARAM1 = "SUMMDATA";
    private static final String ARG_PARAM2 = "COMPERFDATA";
    public NewSelChart() {
        // Required empty public constructor
    }
    public static NewSelChart newInstance(String param1, String param2) {
        NewSelChart fragment = new NewSelChart();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.newselchart, container, false);
...
// Output "2012-09-26"
    ...
    public void SetLV(){
        ...
        myperfdata.add(new GetMyPerfServData("FBN Transfer","40","42,235"));
                                            ...
                                            if(Utility.isNotNull(status)) {
                                                if (((status.equals("SUCCESS"))) && (dbagcmsn > 0)) {
                                                 //   finentry.add(new PieEntry(dbagcmsn, txnname));
                                                    ...
                                                    myperfdata.add(new GetMyPerfServData(txnname,"",Utility.roundto2dp(Double.toString(agamcmn))+session.getString("CURRENCY")));
...
e.printStackTrace();
    ...
    public void Test(String mParam1){
