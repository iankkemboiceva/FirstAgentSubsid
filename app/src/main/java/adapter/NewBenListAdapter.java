...
public class NewBenListAdapter extends ArrayAdapter<BenList> implements Filterable {

	private List<BenList> planetList;
	private Context context;
	private Filter planetFilter;
	private List<BenList> origPlanetList;

	public NewBenListAdapter(List<BenList> planetList, Context ctx) {
	...
	public BenList getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		BenList p = planetList.get(position);
