...
public class ComplainsAdapt extends ArrayAdapter<GetComplaints> implements Filterable {

	private List<GetComplaints> planetList;
	private Context context;
	private Filter planetFilter;
	private List<GetComplaints> origPlanetList;

	public ComplainsAdapt(List<GetComplaints> planetList, Context ctx) {
	...
	public GetComplaints getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GetComplaints p = planetList.get(position);
