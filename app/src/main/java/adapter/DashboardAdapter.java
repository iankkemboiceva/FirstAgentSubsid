...
public class DashboardAdapter extends ArrayAdapter<Dashboard> implements Filterable {
	...
	public DashboardAdapter(List<Dashboard> planetList, Context ctx) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			v = inflater.inflate(R.layout.topthreelist, null);
			// Now we can fill the layout with the right values
			RelativeLayout rlly = (RelativeLayout) v.findViewById(R.id.rlly);
			TextView txtTitle = (TextView) v.findViewById(R.id.txt);

          ImageView imgView = (ImageView)v.findViewById(R.id.picture);
       ...
       // holder.rlly.setBackgroundResource(p.getIdImg());
