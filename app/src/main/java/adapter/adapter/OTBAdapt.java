...
public class OTBAdapt extends ArrayAdapter<OTBList> implements Filterable {

	private List<OTBList> planetList;
	private Context context;
	private Filter planetFilter;
	private List<OTBList> origPlanetList;

	public OTBAdapt(List<OTBList> planetList, Context ctx) {
	...
	public OTBList getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		OTBList p = planetList.get(position);
