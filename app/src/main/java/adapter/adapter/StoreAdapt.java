...
public class StoreAdapt extends ArrayAdapter<StoresList> implements Filterable {

	private List<StoresList> planetList;
	private Context context;
	private Filter planetFilter;
	private List<StoresList> origPlanetList;

	public StoreAdapt(List<StoresList> planetList, Context ctx) {
	...
	public StoresList getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			v = inflater.inflate(R.layout.store_list, null);
		...
		StoresList p = planetList.get(position);


		holder.txtname.setText(p.getStoreName());
        holder.txtid.setText(p.getStoreid()+"(Store Id)");
