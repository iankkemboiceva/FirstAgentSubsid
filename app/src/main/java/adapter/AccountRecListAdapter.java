...
public class AccountRecListAdapter extends RecyclerView.Adapter<AccountRecListAdapter.MyViewHolder> {
    ...
    public AccountRecListAdapter(Context context, List<AccountList> planetList) {
