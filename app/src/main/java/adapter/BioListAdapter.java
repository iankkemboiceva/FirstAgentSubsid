...
public class BioListAdapter extends RecyclerView.Adapter<BioListAdapter.MyViewHolder>   {

	private List<BioList> planetList;
...
/*	public ImeiRvAdapter(List<ImeiList> planetList, Context ctx) {
    ...
    public BioListAdapter(Context context, List<BioList> planetList) {
    ...
    public BioList getItem(int position) {
        return planetList.get(position);
    }

    @Override
    public BioListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);


        View view = inflater.inflate(R.layout.bio_list, parent, false);
    ...
    @Override
    public void onBindViewHolder(BioListAdapter.MyViewHolder holder, int position) {
        BioList p = planetList.get(position);
        String dtype = p.getDtype();
        if(dtype == null){
            dtype = "N/A";
        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        public MyViewHolder(View v) {
            super(v);
            curr = (TextView) v.findViewById(R.id.txt);
