...
import firstmob.firstbank.com.subsidiary.ApplicationConstants;
import firstmob.firstbank.com.subsidiary.Utility;
...
public class AESCBCEncryption implements SecurityConstants {
    ...
    public static String firstLogin(String imei, String params, String session_id, String endpoint) throws UnsupportedEncodingException {
        ...
        return sb.append(ApplicationConstants.NET_URL + ApplicationConstants.AND_ENPOINT + endpoint)
    ...
    public static String generalLogin(String imei, String params, String session_id) throws Exception {
        StringBuffer sb = new StringBuffer();
        ...
        String encappid = toHex(encrypt(key, initVector, ApplicationConstants.APP_ID));

        String vers = "2.0.0";
        String year = "2016";

        //SecurityLayer.Log("1", "=============START KEYS===========");
        //SecurityLayer.Log("encryptedpkey", encryptedpkey);
        //SecurityLayer.Log("encryptedpiv", encryptedRandomIV);
        //SecurityLayer.Log("2", "=============END KEYS===========");

        return sb.append(ApplicationConstants.NET_URL + ApplicationConstants.AND_ENPOINT + "ldapauthetication/")
    ...
    public static  String  b64_sha256(String inputString){
        ...
        if(inputString!=null){
            ...
            SecurityLayer.Log("b64_sha256 outputString::"+outputString);
        }
        else{
